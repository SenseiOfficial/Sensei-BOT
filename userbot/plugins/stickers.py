...
from userbot import ALIVE_NAME, CUSTOM_ANIMATED_PACK_NAME, CUSTOM_STICKER_PACK_NAME
...
CUSTOM_STICKER_NAME = (
    ...
    else "⚜️─ѕєиѕєιвσт─⚜️ Volume Pack One"
)
CUSTOM_ANIME_PACK = (
...
async def _(event):
    ...
    await event.edit(
        "`Bhosdike ! Telegram pe rehna hai to mere se bach ke rehna , mai ye sticker le ke jaa raha hu , Kyu baap ka maal smjh rkha h ?`"
    )
