...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "media":
            ...
            await event.edit(
                "Downloaded to {} in {} seconds by @senseiMAXprojects.".format(
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await event.edit(
                    "Uploaded to https://telegra.ph {} in {} seconds by @senseiMAXprojects.".format(
            ...
            ms = (end - start).seconds
            await event.edit(
                "Pasted to https://telegra.ph/{} in {} seconds by @senseiMAXprojects.".format(
                    response["path"], ms
                ),
                link_preview=True,
            )
