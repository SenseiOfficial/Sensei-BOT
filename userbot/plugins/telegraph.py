...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "media":
            ...
            await event.edit("Downloaded to {} in {} seconds by @senseiMAXprojects.".format(downloaded_file_name, ms))
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await event.edit("Uploaded to https://telegra.ph {} in {} seconds by @senseiMAXprojects.".format(media_urls[0], (ms + ms_two)), link_preview=True)
        elif input_str == "text":
            ...
            ms = (end - start).seconds
            await event.edit("Pasted to https://telegra.ph/{} in {} seconds by @senseiMAXprojects.".format(response["path"], ms), link_preview=True)
    else:
